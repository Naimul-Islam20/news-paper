        ...
        <div class="py-10 min-h-screen">
            <div class="container">
                ...
                <section class="special-grid">
                    ...
                    <div class="bg-white flex flex-col gap-10 md:border-r md:border-slate-200 pr-3">
 
                        {{-- প্রধান নিউজ কার্ড (Featured Article) --}}
                        <article class="flex flex-col md:flex-row gap-3 pb-10  last:border-0 text-left">
                            {{-- বাম: টাইটেল + বিবরণ --}}
                            <div class="flex flex-col justify-start gap-3 flex-1">
                                ...
                                <p class="text-sm font-semibold text-desc leading-relaxed line-clamp-4">
                        ...
                        <div style="display: grid; grid-template-columns: 1fr 1fr 1fr; margin-top: 1rem; padding-top: 1rem; border-top: 1px solid #e2e8f0;">
                            {{-- গ্রিড আইটেম ১ --}}
                            <article class="flex flex-col gap-4" style="padding-right: 0.7rem; border-right: 1px solid #e2e8f0;">
                                <a href="#" class="group overflow-hidden ">
                                    <div class="img-placeholder"><img src="https://loremflickr.com/400/250/politics?lock=21" 
                                         alt="নিউজ ১"
                                         class="w-full h-[180px] object-cover group-hover:scale-105 transition-transform duration-500" onload="this.parentElement.classList.remove('img-placeholder')" ></div>
                                </a>
                                <div class="flex flex-col gap-2">
                                    <a href="#">
                                        <h4 class="text-xl font-bold serif text-title leading-snug hover:text-rose-600 transition-colors line-clamp-2">
                                            রাজনীতির খবর: নতুন বছরে নতুন রাজনৈতিক মেরুকরণ
                                        </h4>
                                    </a>
                                    <p class="text-sm font-medium text-desc leading-relaxed line-clamp-3">
                            ...
                            {{-- গ্রিড আইটেম ২ --}}
                            <article class="flex flex-col gap-4" style="padding-left: 0.7rem; padding-right: 0.7rem; border-right: 1px solid #e2e8f0;">
                                <a href="#" class="group overflow-hidden ">
                                    <div class="img-placeholder"><img src="https://loremflickr.com/400/250/sports?lock=22" 
                                         alt="নিউজ ২"
                                         class="w-full h-[180px] object-cover group-hover:scale-105 transition-transform duration-500" onload="this.parentElement.classList.remove('img-placeholder')" ></div>
                                </a>
                                <div class="flex flex-col gap-2">
                            ...
                            {{-- গ্রিড আইটেম ৩ --}}
                            <article class="flex flex-col gap-4" style="padding-left: 0.7rem;">
                                <a href="#" class="group overflow-hidden ">
                                    <div class="img-placeholder"><img src="https://loremflickr.com/400/250/world?lock=23" 
                                         alt="নিউজ ৩"
                                         class="w-full h-[180px] object-cover group-hover:scale-105 transition-transform duration-500" onload="this.parentElement.classList.remove('img-placeholder')" ></div>
                                </a>
                                <div class="flex flex-col gap-2">
                    ...
                    <div class="flex flex-col pl-3">
                        ...
                        <div class="flex w-full border-b border-gray-200 mb-4">
                            <button id="sp-tab-latest" onclick="switchSpTab('latest')" class="flex-1 text-sm font-bold py-2 border-b-2 border-rose-600 text-rose-600 -mb-px transition-all duration-200 text-center">
                                সর্বশেষ
                            </button>
                            <button id="sp-tab-popular" onclick="switchSpTab('popular')" class="flex-1 text-sm font-bold py-2 border-b-2 border-transparent text-gray-400 -mb-px hover:text-gray-600 transition-all duration-200 text-center">
                                পঠিত
                            </button>
                        </div>
                        ...
                        <div id="sp-panel-latest" class="space-y-4">
                            ...
                            <div class="group cursor-pointer flex items-start gap-3 pb-4 border-b border-gray-100">
                                ...
                                <div class="flex-1">
                                    <h4 class="text-sm font-bold serif leading-snug group-hover:text-rose-600 transition-colors text-left text-title mt-0.5">
                                        ডিজিটাল জনশুমারি: নতুন তথ্যে পাল্টে গেল জনসংখ্যা হিসাব
                                    </h4>
                                </div>
                                <div class="overflow-hidden shrink-0 border border-gray-100 shadow-sm " style="width:64px; height:48px; min-width:64px; min-height:48px;">
                        ...
                        <script>
                            function switchSpTab(tab) {
                                ...
                                document.getElementById('sp-tab-latest').className = 'flex-1 text-sm font-bold py-2 border-b-2 -mb-px transition-all duration-200 text-center ' + (tab === 'latest' ? 'border-rose-600 text-rose-600' : 'border-transparent text-gray-400 hover:text-gray-600');
                                document.getElementById('sp-tab-popular').className = 'flex-1 text-sm font-bold py-2 border-b-2 -mb-px transition-all duration-200 text-center ' + (tab === 'popular' ? 'border-rose-600 text-rose-600' : 'border-transparent text-gray-400 hover:text-gray-600');
                            }
                        </script>
                ...
                <section class="national-grid mt-12 pt-12 border-t border-slate-200">
                    ...
                    <div class="bg-white p-4 flex flex-col gap-5">
 
                        {{-- নিউজ কার্ড ১ --}}
                        <article class="flex gap-4" style="flex-direction: row-reverse;">
                            {{-- বাম: ছবি --}}
                            <a href="#" class="flex-shrink-0">
                                <div class="img-placeholder"><img src="https://loremflickr.com/600/400/parliament,building?lock=1" 
                                     alt="জাতীয় সংসদ"
                                     style="width: 305px; height: 170px;"
                                     class="object-cover" onload="this.parentElement.classList.remove('img-placeholder')" ></div>
                            </a>
                            {{-- ডান: টাইটেল + বিবরণ --}}
                            <div class="flex flex-col justify-start gap-2 pt-1 flex-1">
                                <a href="#">
                                    <h3 class="text-base font-bold serif text-title leading-snug hover:text-rose-600 transition-colors">
                                        জাতীয় সংসদে গুরুত্বপূর্ণ বিল পাস, নতুন আইন কার্যকর হচ্ছে শীঘ্রই
                                    </h3>
                                </a>
                                <p class="text-sm font-semibold text-desc leading-relaxed line-clamp-2">
                        ...
                        <article class="flex gap-4" style="flex-direction: row-reverse;">
                            <a href="#" class="flex-shrink-0">
                                <div class="img-placeholder"><img src="https://loremflickr.com/600/400/economy,money?lock=2" 
                                     alt="অর্থনীতি"
                                     style="width: 305px; height: 170px;"
                                     class="object-cover" onload="this.parentElement.classList.remove('img-placeholder')" ></div>
                            </a>
                        ...
                        <article class="flex gap-4" style="flex-direction: row-reverse;">
                            <a href="#" class="flex-shrink-0">
                                <div class="img-placeholder"><img src="https://loremflickr.com/600/400/city,traffic?lock=3" 
                                     alt="যানজট"
                                     style="width: 305px; height: 170px;"
                                     class="object-cover" onload="this.parentElement.classList.remove('img-placeholder')" ></div>
                            </a>
                            <div class="flex flex-col justify-start gap-2 pt-1 flex-1">
                                ...
                                <p class="text-sm font-semibold text-desc leading-relaxed line-clamp-2">
                                    ঢাকা মহানগরীর যানজট সমস্যা সমাধানে সরকার একটি বিস্তারিত মহাপরিকল্পনা গ্রহণ করেছে। নতুন ফ্লাইওভার এবং মেট্রোরেলের সংযোগ আরও বাড়ানোর প্রস্তাব দেওয়া হয়েছে।
                                </p>
                                <div class="flex items-center gap-1.5 mt-auto text-gray-500">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="11" height="11" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><polyline points="12 6 12 12 16 14"/></svg>
                                    <span class="text-xs font-medium text-gray-500">
                        ...
                        <article class="flex gap-4" style="flex-direction: row-reverse;">
                            <a href="#" class="flex-shrink-0">
                                <div class="img-placeholder"><img src="https://loremflickr.com/600/400/student,college?lock=4" 
                                     alt="শিক্ষা"
                                     style="width: 305px; height: 170px;"
                                     class="object-cover" onload="this.parentElement.classList.remove('img-placeholder')" ></div>
                            </a>
                            <div class="flex flex-col justify-start gap-2 pt-1 flex-1">
                                ...
                                <p class="text-sm font-semibold text-desc leading-relaxed line-clamp-2">
                                    সরকার আগামী বাজেটে শিক্ষা খাতে বরাদ্দ বাড়ানোর পরিকল্পনা করেছে। গবেষণার কাজে সহায়তার জন্য প্রতিটি জেলায় আধুনিক ল্যাবরেটরি তৈরি করা হবে।
                                </p>
                                <div class="flex items-center gap-1.5 mt-auto text-gray-500">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="11" height="11" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><polyline points="12 6 12 12 16 14"/></svg>
                                    <span class="text-xs font-medium text-gray-500">
