    ...
    <div class="container overflow-visible">
        ...
        <div class="flex flex-col md:flex-row justify-between items-center gap-8 mb-4 pb-4 border-b border-gray-300">
            ...
            <div class="flex flex-wrap justify-center md:justify-end gap-4">
                <a href="#" class="flex items-center gap-2 bg-black text-white px-6 py-2 rounded-lg hover:bg-slate-800 transition-all shadow-sm">
        ...
        <div class="grid grid-cols-1 md:grid-cols-12 gap-8 pt-4">
            ...
            <div class="md:col-span-4 md:border-r border-slate-200 md:pr-4">
                <div class="grid grid-cols-2 lg:grid-cols-3 gap-y-4 gap-x-2 text-base font-semibold">
                    ...
                    <a href="#" class="hover:text-rose-600 transition-colors">ছবি</a>
                    <a href="#" class="hover:text-rose-600 transition-colors">বাংলা কনভার্টার</a>
                    <a href="#" class="hover:text-rose-600 transition-colors">ভিডিও</a>
                    <a href="#" class="hover:text-rose-600 transition-colors">পরিবেশ</a>
                    <a href="#" class="hover:text-rose-600 transition-colors">প্রবাস</a>
                    <a href="#" class="hover:text-rose-600 transition-colors">সাহিত্য</a>
                    <a href="#" class="hover:text-rose-600 transition-colors">চাকরি</a>
                </div>
            </div>
